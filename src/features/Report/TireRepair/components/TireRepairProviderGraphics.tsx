...
import { TireRepairGraphicsResponse } from "../types/tireRepairTypes";

export { TireRepairProviderGraphics };
...
interface TireRepairProviderGraphicsProps {
  data: TireRepairGraphicsResponse[];
}

function TireRepairProviderGraphics({ data }: TireRepairProviderGraphicsProps) {
        ...
        <Line
          data={{
            ...
            datasets: [
              ...
              {
                label: `${t("general:average_days_repair")}`,
