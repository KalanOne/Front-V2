...
import { UseTireRepairDependenciesReturns } from "../hooks/dependencies";
import {
  TireRepairFilterInputType,
  TireRepairFilterSchemaType,
} from "../validation/filterTireRepair";

export { TireRepairFilterForm };

interface TireRepairFilterFormProps {
  form: UseFormReturn<
    TireRepairFilterInputType,
    unknown,
    TireRepairFilterSchemaType
  >;
  dependencies: UseTireRepairDependenciesReturns;
}

function TireRepairFilterForm({
  form,
  dependencies,
}: TireRepairFilterFormProps) {
