...
import { TireRepairFilterSchemaType } from "../validation/filterTireRepair";

export { TireRepairFilters };

interface TireRepairFiltersProps {
  selectedFilters: Partial<Record<keyof TireRepairFilterSchemaType, string>>;
}

function TireRepairFilters({ selectedFilters }: TireRepairFiltersProps) {
