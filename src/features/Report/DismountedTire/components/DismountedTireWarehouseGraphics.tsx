...
import { DismountedTireGraphicsResponse } from "../types/dismountedTireTypes";

export { DismountedTireWarehouseGraphics };
...
interface DismountedTireWarehouseGraphicsProps {
  data: DismountedTireGraphicsResponse[];
}

function DismountedTireWarehouseGraphics({
  data,
}: DismountedTireWarehouseGraphicsProps) {
