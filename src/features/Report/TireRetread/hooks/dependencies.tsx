...
export { useTireRetreadDependencies };
export type { UseTireRetreadDependenciesReturns };

interface UseTireRetreadDependenciesArgs {
  corporate_id?: string | number;
  company?: number[];
  subsidiary?: number[];
}

interface UseTireRetreadDependenciesReturns {
...
function useTireRetreadDependencies({
  corporate_id = "",
  company = [],
  subsidiary = [],
}: UseTireRetreadDependenciesArgs): UseTireRetreadDependenciesReturns {
