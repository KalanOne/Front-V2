...
import { TireRetreadTableResponse } from "../types/tireRetreadTypes";

export { TireRetreadProviderTable };

interface TireRetreadProviderTableProps {
  title: string;
  tires: TireRetreadTableResponse[];
}

function TireRetreadProviderTable({
  title,
  tires,
}: TireRetreadProviderTableProps) {
