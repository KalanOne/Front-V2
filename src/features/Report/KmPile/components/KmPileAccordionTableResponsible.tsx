...
import { KmPileResponsibleAccordionRow } from "./KmPileResponsibleAccordionRow";

export { KmPileAccordionTableResponsible };

interface KmPileAccordionTableResponsibleProps {
  extra: any;
  dataObject: any;
  handleResponsibleClick: (data: any) => void;
}

function KmPileAccordionTableResponsible({
  extra,
  dataObject,
  handleResponsibleClick,
}: KmPileAccordionTableResponsibleProps) {
