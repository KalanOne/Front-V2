...
import { PileModelTableResponse } from "../types/pileTypes";

export { ModelTable };

interface ModelTableProps {
  data: PileModelTableResponse[];
}
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableHeaderCellLightGray>
              {t("labels2:report_pile.utils_mm")}
            </TableHeaderCellLightGray>
            <TableHeaderCellLightGray>
              {t("labels2:report_pile.cost_mm")}
            </TableHeaderCellLightGray>
            <TableHeaderCellLightGray>
              {t("labels2:report_pile.cost_useful")}
            </TableHeaderCellLightGray>
          </TableRow>
        </TableHead>
        <TableBody>
          {data
            ...
            .map((tire: PileModelTableResponse) => (
