...
import { PileFilterSchemaType } from "../validation/filterPile";

export { PileFilters };

interface PileFiltersProps {
  selectedFilters: Partial<Record<keyof PileFilterSchemaType, string>>;
}

function PileFilters({ selectedFilters }: PileFiltersProps) {
