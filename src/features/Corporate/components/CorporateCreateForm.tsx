...
import { CorporateCreateSchemaType } from "../validation/createCorporate";

export { CorporateCreateForm };

interface CorporateCreateFormProps {
  form: UseFormReturn<CorporateCreateSchemaType>;
}

function CorporateCreateForm({
  form,
}: CorporateCreateFormProps): React.ReactElement {
