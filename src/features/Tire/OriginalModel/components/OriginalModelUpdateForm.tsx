...
import { OriginalModelUpdateSchemaType } from "../validation/updateOriginalModel.ts";

export { OriginalModelUpdateForm };

interface OriginalModelUpdateFormProps {
  form: UseFormReturn<OriginalModelUpdateSchemaType>;
  sizesInput: SizeResponseInput[];
  brandsInput: BrandResponseInput[];
}

function OriginalModelUpdateForm({
  form,
  sizesInput,
  brandsInput,
}: OriginalModelUpdateFormProps): React.ReactElement {
