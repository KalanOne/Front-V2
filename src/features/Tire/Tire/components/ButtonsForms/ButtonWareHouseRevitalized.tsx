...
import { SendToWareHouseSchemaType } from "../../validation/sendToWareHouse";

export { ButtonWareHouseRevitalizedForm };

interface ButtonWareHouseRevitalizedFormProps {
  form: UseFormReturn<SendToWareHouseSchemaType>;
  tire?: TireResponse;
  dependencies: UseTireRevitalizedDependenciesReturns;
}

function ButtonWareHouseRevitalizedForm({
  form,
  tire,
  dependencies,
}: ButtonWareHouseRevitalizedFormProps): React.ReactElement {
