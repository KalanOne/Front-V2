...
import { VehiclesUpdateSchemaType } from "../validation/UpdateVehicles";

export { VehiclesUpdateForm };

interface VehiclesUpdateFormProps {
  form: UseFormReturn<VehiclesUpdateSchemaType>;
  dependencies: UseVehiclesDependenciesArgsReturn;
}

function VehiclesUpdateForm({
  form,
  dependencies,
}: VehiclesUpdateFormProps): React.ReactElement {
