...
} from "../../VehicleReview/api/vehicleReviewApi";
import { useVehicleReviewDependencies } from "../../VehicleReview/hooks/dependencies";
import {
  VehicleReviewResponse,
  VehicleReviewResponseInProcess,
} from "../../VehicleReview/types/vehicleReviewTypes";
import {
...
function Mounting() {
  ...
  const mountingInProcessQuery = useCrudQuery({
    apiFunction: getVehicleReviewsInProcess,
    name: "mountingInProcess",
  ...
  // const mountingsInProcess = mountingInProcessQuery.data?.data ?? [];
      ...
      <BaseContainer title={t("general:mounting")}>
        <Container sx={{ p: 3 }} maxWidth={"xl"}>
          ...
          >
            ...
            >
              <Badge
                badgeContent={mountingInProcessQuery.data?.total ?? "?"}
                color="secondary"
                sx={{
                  ml: 2.5,
                  "& span": {
          ...
          <MountingTable mountings={mountings} />
          <CustomPagination
            page={crud.page}
