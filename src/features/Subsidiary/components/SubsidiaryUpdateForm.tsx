...
import { SubsidiaryUpdateSchemaType } from "../validation/updateSubsidiary";

export { SubsidiaryUpdateForm };

interface SubsidiaryUpdateFormProps {
  form: UseFormReturn<SubsidiaryUpdateSchemaType>;
  companies: CompanyResponse[];
}

function SubsidiaryUpdateForm({
  form,
  companies,
}: SubsidiaryUpdateFormProps): React.ReactElement {
