...
import { getData } from "../api/pressureApi";
...
interface UseDataDependenciesArgs {
  ...
  vehicle_id?: string;
  vehicle_pressure_policy_id?: string;
}
...
function useDataDependencies({
  subsidiary_id = "",
  vehicle_id = "",
  vehicle_pressure_policy_id = "",
}: UseDataDependenciesArgs): UseDataDependenciesReturns {
  const dataQuery = useQuery({
    queryKey: ["data", vehicle_id, vehicle_pressure_policy_id],
    queryFn: async () => {
      return await getData({
        params: {
          subsidiary_id:subsidiary_id,
          vehicle_id:vehicle_id,
          vehicle_pressure_policy_id:vehicle_pressure_policy_id,
        },
        extras: undefined,
      });
    },
    enabled: vehicle_id !== "" && vehicle_pressure_policy_id !== "",
  });
