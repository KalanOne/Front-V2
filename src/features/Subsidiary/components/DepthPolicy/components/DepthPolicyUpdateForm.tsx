...
import { DepthPolicyUpdateSchemaType } from "../validation/updateDepthPolicy";

export { DepthPolicyUpdateForm };

interface DepthPolicyUpdateFormProps {
  form: UseFormReturn<DepthPolicyUpdateSchemaType>;
}

function DepthPolicyUpdateForm({
  form,
}: DepthPolicyUpdateFormProps): React.ReactElement {
