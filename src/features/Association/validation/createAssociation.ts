...
export { associationCreateSchema, associationCreateDefaultValues };
export type { AssociationCreateSchemaType };
...
type AssociationCreateSchemaType = z.infer<typeof associationCreateSchema>;

interface AssociationCreateDefaultValues {
  name: string;
...
const associationCreateDefaultValues: AssociationCreateDefaultValues = {
  name: "",
  subsidiary_id: 0,
  direction_1: "",
  external_number: "",
