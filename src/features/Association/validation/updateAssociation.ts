...
export { associationUpdateSchema, associationUpdateDefaultValues };
export type { AssociationUpdateSchemaType };
...
type AssociationUpdateSchemaType = z.infer<typeof associationUpdateSchema>;

interface AssociationUpdateDefaultValues {
  name: string;
...
const associationUpdateDefaultValues: AssociationUpdateDefaultValues = {
  name: "",
  subsidiary_id: 0,
  direction_1: "",
  external_number: "",
