...
import { AssociationUpdateSchemaType } from "../validation/updateAssociation.ts";

export { AssociationUpdateForm };

interface AssociationUpdateFormProps {
  form: UseFormReturn<AssociationUpdateSchemaType>;
  subsidiaries: SubsidiaryInputResponse[];
}

function AssociationUpdateForm({
  form,
  subsidiaries,
}: AssociationUpdateFormProps): React.ReactElement {
