...
export { wareHouseUpdateSchema, wareHouseUpdateDefaultValues };
export type { WareHouseUpdateSchemaType };
...
interface WareHouseUpdateDefaultValues {
  name: string;
...
const wareHouseUpdateDefaultValues: WareHouseUpdateDefaultValues = {
  name: "",
  subsidiary_id: 0,
  direction_1: "",
  external_number: "",
