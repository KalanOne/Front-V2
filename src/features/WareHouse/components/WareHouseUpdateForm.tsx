...
import { WareHouseUpdateSchemaType } from "../validation/updateWareHouse";

export { WareHouseUpdateForm };

interface WareHouseUpdateFormProps {
  form: UseFormReturn<WareHouseUpdateSchemaType>;
...
function WareHouseUpdateForm({
  form,
  subsidiaries,
}: WareHouseUpdateFormProps): React.ReactElement {
