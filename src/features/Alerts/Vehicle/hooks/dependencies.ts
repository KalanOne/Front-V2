...
export { useAlertVehicleDependencies };
export type { UseAlertVehicleDependenciesArgsReturn };

interface UseAlertVehicleDependenciesArgsReturn {
...
function useAlertVehicleDependencies(): UseAlertVehicleDependenciesArgsReturn {
