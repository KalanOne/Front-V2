...
import { RevitalizedTireModelUpdateSchemaType } from "../validation/updateRevitalizedTireModel.ts";

export { RevitalizedTireModelUpdateForm };

interface RevitalizedTireModelUpdateFormProps {
  form: UseFormReturn<RevitalizedTireModelUpdateSchemaType>;
  dependencies: UseBrandsQueryDependenciesReturns;
}

function RevitalizedTireModelUpdateForm({
  form,
  dependencies,
}: RevitalizedTireModelUpdateFormProps): React.ReactElement {
