...
import { DriverCreateSchemaType } from "../validation/createDriver";

export { DriverCreateForm };

interface DriverCreateFormProps {
  form: UseFormReturn<DriverCreateSchemaType>;
...
function DriverCreateForm({
  form,
  subsidiaries,
}: DriverCreateFormProps): React.ReactElement {
