...
import { BrandUpdateSchemaType } from "../validation/updateBrand.ts";

export { BrandUpdateForm };

interface BrandUpdateFormProps {
  form: UseFormReturn<BrandUpdateSchemaType>;
}

function BrandUpdateForm({ form }: BrandUpdateFormProps): React.ReactElement {
